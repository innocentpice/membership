<?php $item = $this->businessList;?>

<main>
  <div class="container" style="padding:0em 1em;margin-top:2em;">
    <div class="row">
      <div class="col s12">
        <form id="frm_addbusiness" method="post">
          <div class="row">
          <div class="col s12 card-panel" style="padding:2em;">
            ...
            <div class="row">
              ...
              <div class="input-field col s12">
                <input id="b_name" type="text" class="validate" data-length="50" name="name" value="<?=$item['name']?>">
                <label for="b_name">ชื่อธุรกิจ</label>
              </div>
              <div class="input-field col s12">
                <input id="b_detail" type="text" class="validate" data-length="100" name="detail" value="<?=$item['detail']?>">
                <label for="b_detail">รายละเอียดธุรกิจ</label>
              </div>
              <div class="input-field col s12">
                <select name="type21">
                  <option value="<?=$item['type21']?>" selected><?=$item['type21']?></option>
              ...
              <div class="input-field col s12">
                <select name="type23">
                  <option value="<?=$item['type23']?>" selected><?=$item['type23']?></option>
              ...
              <div class="input-field col s12">
                <input id="b_address" type="text" class="validate" data-length="100" name="address" value="<?=$item['address']?>">
                <label for="b_address">ที่อยู่สำนักงาน</label>
              </div>
              <div class="input-field col s12">
                <input id="b_tel" type="text" class="validate" data-length="10" name="tel" value="<?=$item['tel']?>">
                <label for="b_tel">โทรศัพท์</label>
              </div>
              <div class="input-field col s12">
                <input id="b_fax" type="text" class="validate" data-length="10" name="fax" value="<?=$item['fax']?>">
                <label for="b_fax">แฟกซ์</label>
              </div>
              <div class="input-field col s12">
                <input id="b_website" type="text" class="validate" data-length="100" name="website" value="<?=$item['website']?>">
              ...
              <div class="input-field col s12">
                ...
                <input id="MapAddress_lat" type="hidden" name="map_lat" value="<?=$item['map_lat']?>">
                <input id="MapAddress_lng" type="hidden" name="map_lng" value="<?=$item['map_lng']?>">
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12 center-align">
                <button type="submit" name="editbusiness" value="submit" id="btn-done" class="btn btn-block waves-effect waves-light btn-large lime darken-1">
